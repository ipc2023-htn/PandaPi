...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->downward_help = gengetopt_args_info_help[38] ;
  args_info->downwardConf_help = gengetopt_args_info_help[39] ;
  args_info->transtype_help = gengetopt_args_info_help[40] ;
  args_info->forceTransType_help = gengetopt_args_info_help[41] ;
  args_info->sasfile_help = gengetopt_args_info_help[42] ;
  args_info->pgb_help = gengetopt_args_info_help[43] ;
  args_info->pgbsteps_help = gengetopt_args_info_help[44] ;
  args_info->onlyGenerate_help = gengetopt_args_info_help[45] ;
  args_info->iterate_help = gengetopt_args_info_help[46] ;
  args_info->realCosts_help = gengetopt_args_info_help[47] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hdS:t:Npsb2IH:w:g:VTQOBMP:m", long_options, &option_index);
